...
CONFIG = {
    ...
    'input_file': 'your_data.parquet',  # Update this to your input file path
    'output_parquet': 'Fall_Assist_Sentiment_Output.parquet',
    'output_csv': 'Fall_Assist_Sentiment_Output.csv',
